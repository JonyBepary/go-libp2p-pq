...
func TestBasicSignAndVerifyDillithium(t *testing.T) {
	...
	sig := mode.Sign(priv, data)

	if err != nil {
		t.Fatal(err)
	}

	ok := mode.Verify(pub, data, sig)
...
func TestSignZeroDillithium(t *testing.T) {
	mode := dilithium.Mode2
	pub, priv, err := mode.GenerateKey(rand.Reader)
	if err != nil {
		t.Fatal(err)
...
// func TestMarshalLoopDillithium(t *testing.T) {
// 	mode := dilithium.Mode2
// 	pub, priv, err := mode.GenerateKey(rand.Reader)
// 	if err != nil {
// 		t.Fatal(err)
...
// 			},
// 		} {
// 			t.Run(name, funcDillithium(t *testing.T) {
// 				bts, err := f()
// 				if err != nil {
// 					t.Fatal(err)
// 				}
...
// 	t.Run("PublicKey", funcDillithium(t *testing.T) {
// 		for name, f := range map[string]func() ([]byte, error){
// 			"Marshal": func() ([]byte, error) {
...
// func TestUnmarshalErrorsDillithium(t *testing.T) {
// 	t.Run("PublicKey", funcDillithium(t *testing.T) {
// 		t.Run("Invalid data length", funcDillithium(t *testing.T) {
...
// 	t.Run("PrivateKey", funcDillithium(t *testing.T) {
// 		t.Run("Redundant public key mismatch", funcDillithium(t *testing.T) {
